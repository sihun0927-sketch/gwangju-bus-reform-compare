...
여섯은 시가 공표한 원본(2026-09-02 반입, UTF-8 BOM)이고, `stops.csv`는 광주 BIS API에서 받아
만든 것이며(2026-09-03, ADR-0007), `route_headways_with_stops.csv`는 개편 전 배차간격이다
(2026-09-04 반입, 아래 절). **손으로 고치지 않는다.** 빌드 스크립트는 읽기만 한다 —
