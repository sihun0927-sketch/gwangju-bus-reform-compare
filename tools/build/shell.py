...
#
# 그래도 **가까운 자리를 고른다.** 「롯데마트 수완점」의 좌표가 그 뜻이다 — 이름이 가리키는 곳에서
# 58m인 신창호반아파트다. 전에 쓰던 수완동 자리는 369m로 도보권 안이긴 하나, 이름을 콕 집은 뒤로는
# 시민이 그 앞에서 출발한다고 읽으므로 자리도 거기 맞춘다(2026-09-04).
EXAMPLES_TITLE = "예시 검색"
EXAMPLES = (
    ("유스퀘어", "35.16177,126.87969568", "전남대학교", "35.17009722,126.90382222"),
    ("금남로4가역", "35.15123889,126.91349741", "첨단지구", "35.21757203,126.84071599"),
    ("조선대학교", "35.144841,126.92601", "롯데마트 수완점", "35.19906039,126.8382812"),
)
