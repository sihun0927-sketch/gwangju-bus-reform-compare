 ...
 *
 * 카드 **안**에 두면 같은 문장이 두 번 서고, 카드 높이도 먹어 지표 표가 어긋난다. 뒤 세 줄은
 * 시민이 걸려 넘어지는 자리다 — 「왜 더 짧은 분이 아래 있지」와 「왜 내가 아는 정류장이 아니지」와
 * 「왜 개편 후만 정보 없음이지」.
 */
const 각주 = 목록("notes", [
  `예상 시간은 정류장당 ${SECONDS_PER_STOP}초와 걷는 속도 ${WALK_SPEED_KMH}km/h로 잡은`
    ...
    + " 배차 대기는 넣지 않았습니다.",
  "경로를 고르는 차례는 배차간격의 절반을 기다린다고 보고 매겼습니다 — 그래서 예상 시간이 더 짧은"
    + " 경로가 아래에 설 수 있습니다.",
